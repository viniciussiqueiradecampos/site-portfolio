        ...
        <div className="blog-page" style={{ padding: '120px 0', background: 'var(--bg-color)', minHeight: '100vh' }}>
            <div className="container" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 5%' }}>
                ...
                <header style={{ marginBottom: '80px' }}>
                    <RevealText>
                        <h1 style={{ fontSize: 'clamp(40px, 8vw, 100px)', fontWeight: 900, marginBottom: '20px' }}>INSIGHTS &<br />STORIES</h1>
                    </RevealText>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fill, minmax(350px, 1fr))', gap: '40px' }}>
                        ...
                        {filteredPosts.length === 0 && (
                            <div style={{ textAlign: 'center', padding: '100px 0', gridColumn: '1/-1' }}>
                                ...
                                <button onClick={() => { setSelectedCategory(null); setSearchQuery(''); }} style={{ marginTop: '20px', background: 'transparent', border: '1px solid var(--border-color)', color: '#fff', padding: '10px 20px', borderRadius: '100px', cursor: 'pointer' }}>Clear all filters</button>
                            </div>
                        )}
                    </div>
